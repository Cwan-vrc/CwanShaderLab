...
#define _Smoothness_arr CwanShaderleafVertexWave
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 temp_cast_0 = (voroi173).xx;
			float2 panner280 = ( 1.0 * _Time.y * float2( 0,0 ) + temp_cast_0);
			...
			float2 temp_cast_2 = (v.texcoord.xy.x).xx;
			float2 panner188 = ( ( _Time.w * 72.82 ) * float2( 0,0 ) + temp_cast_2);
			...
			float4 temp_cast_3 = (( lerpResult279 + -0.63 )).xxxx;
			float2 uv211 = 0;
			float3 unityVoronoy211 = UnityVoronoi(panner172,temp_output_182_0,50.0,uv211);
			float2 WaveNoise54 = ( ( panner280 * voroi178 ) * ( ( CalculateContrast(1.0,temp_cast_3) * unityVoronoy211.x ) * -1.0 ) );
			float3 appendResult11_g1 = (float3(break3_g1.x , ( break3_g1.y + ( sin( ( ( break3_g1.x * ( Frequency12 * temp_output_47_0 ) ) + mulTime4_g1 ) ) * ( ( Ampritude10 * v.texcoord.xy ) * ( temp_output_47_0 * WaveNoise54 ) ).x ) ) , break3_g1.z));
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;2799.22;54.24118;1.3;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;201;-221.1533,577.3547;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;217;66.8467,257.3547;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;54;338.8468,257.3547;Float;False;WaveNoise;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;56;-1584,-144;Inherit;False;54;WaveNoise;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;53;-1360,-304;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-1360,-464;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-688,-1119;Inherit;True;Property;_BaseAlbedo;BaseAlbedo;0;0;Create;True;0;0;0;False;1;;False;-1;None;023c65568c300ea4badcbe915af26cf7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AEB37D7B727E61B661BB2AA7F803FB00CF7B369F
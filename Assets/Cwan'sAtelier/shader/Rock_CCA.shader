...
Shader "CwanShader/Rock_CCA"
{
	Properties
	{
		...
		_AO("AO", Range( 0 , 1)) = 1
		_Float8("Float 8", Float) = 0.2
		_Float9("Float 9", Range( 0 , 1)) = 1
		_TextureSample1("Texture Sample 1", 2D) = "white" {}
		_Color0("Color 0", Color) = (0,0,0,0)
		_Float10("Float 10", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult224 = lerp( tex2D( _TextureSample1, uv_TextureSample1 ) , float4( (_Color0).rgb , 0.0 ) , _Color0.a);
			...
			float lerpResult217 = lerp( saturate( ( ( ( (saturate( ( Fetch_Lightmap173 + _Float8 ) )).x - 0.5 ) * 10.0 ) + 0.5 ) ) , saturate( ( ((WorldNormalVector( i , Normal_Output163.rgb ))).y + 0.2 ) ) , _Float9);
			...
			float lerpResult235 = lerp( (Smooth_Output145).x , ( ( 1.0 - lerpResult217 ) * 0.0 ) , _Float10);
			o.Smoothness = lerpResult235;
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;1159.79;1291.491;1.3;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;209;-688,-1712;Inherit;False;173;Fetch_Lightmap;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;214;-688,-1632;Inherit;False;Property;_Float8;Float 8;10;0;Create;True;0;0;0;False;0;False;0.2;-0.26;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;212;-464,-1712;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;208;12,-1751;Inherit;False;936.8185;298.9611;Comment;6;203;202;205;204;206;207;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SaturateNode;213;-320,-1712;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SwizzleNode;215;-160,-1712;Inherit;False;FLOAT;0;1;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;203;60,-1607;Inherit;False;Constant;_Float6;Float 6;9;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;205;268,-1575;Inherit;False;Constant;_Float7;Float 7;9;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;202;268,-1703;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;204;444,-1703;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;206;636,-1703;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;201;267.7346,-1317.176;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;207;780,-1703;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;89.73711,-1184.888;Inherit;False;Property;_Float9;Float 9;11;0;Create;True;0;0;0;False;0;False;1;0.4984911;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;154;-880,576;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;217;602.7675,-1286.067;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;225;-786.7107,-1005.503;Inherit;False;Property;_Color0;Color 0;13;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.1981132,0.04661484,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;222;-802.7107,-1181.503;Inherit;True;Property;_TextureSample1;Texture Sample 1;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SwizzleNode;226;-539.7107,-1029.503;Inherit;False;FLOAT3;0;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;234;589.7799,-1105.69;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;224;-352,-1072;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;171;-637.7263,-378.3127;Inherit;False;126;AO_Output;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;232;-170.3549,-704.7807;Inherit;False;Property;_Float10;Float 10;14;0;Create;True;0;0;0;False;0;False;0;0.6711633;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;229;770.3271,-1008.42;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;235;37.90659,-523.7975;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;237;150.261,-953.3206;Inherit;False;43;TriDirt;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;221;-125.5153,-929.3751;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=0D54A6CBF2304AC2CB9F755837D34D25AA761321